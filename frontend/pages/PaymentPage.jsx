...
function markPaymentConfirmed(tripId) {
  localStorage.setItem('jpTaxiPaymentCompleted', JSON.stringify({
    tripId,
...
function isAlreadyClosedPaymentError(error) {
  ...
  return message.includes('đã được thanh toán')
...
export default function PaymentPage() {
  ...
  async function confirmPayment() {
    ...
    let tripId = getStoredTripId(trip);
    ...
    markPaymentConfirmed(tripId);
    clearCompletedRideBookingState();
    navigate(backPath === '/driver-ride-status' ? '/driver-ride-status' : `/driver-review?tripId=${tripId}`, { replace: true });
  }
