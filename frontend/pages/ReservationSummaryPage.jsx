        ...
        <section className="app-shell">
          ...
          <div className="two-column-layout">
            <section className="panel">
              ...
              <div className="route-line-card">
                <div className="route-step">
                  ...
                  <div><strong>ハノイ・ホアンキエム周辺</strong><span className="muted-small">2026/05/15 09:30 出発</span></div>
                </div>
                <div className="route-step">
                  <span className="step-dot dark">B</span>
                  <div><strong>ノイバイ国際空港</strong><span className="muted-small">到着予定 10:08</span></div>
                </div>
              </div>
            ...
            <aside className="panel">
              ...
              <Link className="submit-button stack" style={{ display: 'grid', placeItems: 'center', textDecoration: 'none' }} to="/search-car">
                予約を確定する
              </Link>
              <Link className="secondary-button stack" style={{ display: 'grid', placeItems: 'center', textDecoration: 'none' }} to="/advance-booking">
                修正する
              </Link>
            </aside>
          </div>
